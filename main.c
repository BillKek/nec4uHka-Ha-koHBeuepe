...
int main()
{
    ...
    f скорость_ко_регулируемая_м_с = 1.0;
    f скорость_ко_тек_м_с= скорость_ко_регулируемая_м_с;
...
outvar(энергия_кинет_до);
    ...
    f энергия_кинет_после_работы_двигателя;
    энергия_кинет_после_работы_двигателя = 0.0;
    энергия_кинет_после_работы_двигателя = скорость_ко_регулируемая_м_с*скорость_ко_регулируемая_м_с*масса_песчинки_кг/2.0;
    энергия_кинет_после_работы_двигателя += скорость_ко_регулируемая_м_с*скорость_ко_регулируемая_м_с*масса_ко_кг/2.0;
    f КПД = энергия_кинет_песчинки/(энергия_кинет_после_работы_двигателя - энергия_кинет)*100.0;
    outvar(КПД);
